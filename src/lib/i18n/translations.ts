...
export const TRANSLATIONS: Record<LanguageCode, UiTranslations> = {
  ms: {
    ...
    entry_pronoun_paradigm_desc: 'Hubungan sistematik antara Bentuk Bebas (Set II), Bentuk Terikat / Enklitik (Set I), dan Bentuk Oblik / Sasaran (Set III: em- + Set II).',
    ...
    notfound_badge: 'Perkataan Belum Di',
    notfound_desc: 'Perkataan ini belum terdapat dalam pangkalan data rasmi Kamus Bajau Sama. Anda boleh menjadi penyumbang pertama untuk mennya!',
  ...
  bj: {
    ...
    entry_variants: 'Varian Ejaan',
    entry_dialects: 'Variasi Da\'ira',
    entry_definition: 'Maksud',
    entry_examples: 'Sonto Pegunoon',
    entry_thesaurus: 'TESAURUS',
    entry_pronoun_paradigm_kicker: 'PARADIGMA NAHU SAMA',
    entry_pronoun_paradigm_title: 'Sarta\' Paradigma Koto Gantian Diri',
    entry_pronoun_paradigm_desc: 'Ubungan sistematik antawa Matukan Lepa (Set II), Bentuk Teingkot / Enklitik (Set I), ko Bentuk Oblik / Tuju (Set III: em- + Set II).',
    ...
    about_title: "Melioro Warisan Lisan,<br>Mepoyo Pemakai <em>Generasi Bau.</em>",
    about_lead: "<strong>Kamus Bajau Sama</strong> iono poon leksikal digital binuka' yang niasas untuk mendokumentésén, mera'i ko' mepeluasan kosa kata bahasa Bajau Sama supaya kekal ellum ko' tebuka ta' masarakat.",
    about_pillar_1_title: 'Ékses Tebuka & Digital',
    about_pillar_1_desc: "Mepejadi kosokoto basa Sama sanang pinemia, nipaam ko' nikunsi ngerentas keékoon peranti empengalaman pemiaan lingau ko\' ngam.",
    about_pillar_2_title: 'Ketulinan & Intigriti Data',
    about_pillar_2_desc: "Bilang-bilang pekotoon, taatan engko' sonto ayat nipelioro nuut matukan petuturan tulin lé' penutur jati tanpa dikau' rékoon atau pengubasedongon leksikal.",
    about_pillar_3_title: 'Variasi Da\'ira',
    about_pillar_3_desc: "Mendokumentésén keékoon dialek Sama ta' Sabah.",
    about_methodology_title: 'Metodologi & Sumber Rujukan',
    about_methodology_desc: "Kandungan diom kamus tu nikumpul engko' gabungan sumber lisan man wergo emas, penutur jati, ko' rujukan dokumentésén linguistik ko' akademik yang niiktirap.",
    about_cta_title: 'Sumbangin Pengeratian-nu',
    about_cta_desc: "Kamus tu bekembang sebia engko' sumbangan-nu. Amun ngerati-nu pekotoon, sebutan, lugat setungan atau sonto ayat bau, kongsino engkami untuk nirego ko' niposok diom data rasmi.",
    about_cta_btn: '+ Sadang Pekotoon Betiu',

    modal_suggest_title: 'Sadang Entri Bau',
    modal_suggest_desc: 'Bantuno engkami ngoyoon Kamus Bajau Sama. Sekemon sadangan komuniti akan nirego sebelum pinosokon diom kamus rasmi.',
    ...
    modal_success_toast: 'Terimo Kasi! Sadangan pekotoon-nu tekulé\' lé\' kami untuk nirego.',
    ...
    footer_brand_desc: "Inisiatip melioro kazana kosokoto ko' warisan leksikal basa Sama tebuka' untuk generasi betiu ko' masa bunda'.",
    footer_nav_title: 'Pekos Lingau',
    ...
    footer_dialects_title: 'Variasi Lego\' & Da\'ira',
    footer_dialects_desc: 'Mendokumentésén keékoon leksikal Sama Pantai Barat (Kota Belud, Tuaran, Papar).',
    footer_heritage_title: 'Intigriti Basa',
    footer_heritage_desc: 'Pungkaan data betuut penutur jati ko\' poon lisan tulin.',
    footer_copyright: 'Kamus Bajau Sama. Hak sipto tepelioro.',
    footer_motif_note: 'Motip Tradisional & Linangkit Sabah',
    ...
    entry_link_copied: 'Pekos sinalin!',
